...
models <- list(
"Model 1" =  gam(dist_search ~ s(stage, k = 4, fx = TRUE, by = type) + type, data = df4, family = betar(link="logit"), method = "REML"),
"Model 2" = gam(dist_search ~ s(stage, k = 4, fx = TRUE, by = type) + type, data = df5, family = betar(link="logit"), method = "REML")
)
